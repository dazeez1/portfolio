  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="bg-surface-alt py-16 md:py-24">
          <Container>
            <h2 className="sr-only">{educationTitle}</h2>
            <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
              <div>
                <SectionHeading title="Education" as="h3" />
                <Card className="mt-6">
                  <TagPill variant="tinted">{degree.detail}</TagPill>
                  <h4 className="mt-4 font-serif text-xl text-ink">
                    {degree.title}
                  </h4>
                  <p className="mt-2 font-sans text-sm text-text-secondary">
                    {degree.institution}
              ...
              <div>
                <SectionHeading title="Certifications" as="h3" />
